                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="sb-main-title-frame">
                                    <div class="sb-main-title">
                                        ...
                                        <a href="#" class="sb-btn">
                                            <span class="sb-icon">
                                                <img src="/src/assets/img/ui/icons/menu.svg" alt="icon">
                                            </span>
                                            <span>Our menu</span>
                                        </a>
                                        <!-- button end -->
                            ...
                            <div class="col-lg-6">
                                <div class="sb-illustration-1">
                                    <img src="/src/assets/img/illustrations/girl.png" alt="girl" class="sb-girl">
                                    <div class="sb-cirkle-1"></div>
                                    <div class="sb-cirkle-2"></div>
                                    <div class="sb-cirkle-3"></div>
                                    <div class="sb-cirkle-4"></div>
                                    <div class="sb-cirkle-5"></div>
                                    <img src="/src/assets/img/illustrations/3.svg" alt="phones" class="sb-pik-1">
                                    <img src="/src/assets/img/illustrations/1.svg" alt="phones" class="sb-pik-2">
                                    <img src="/src/assets/img/illustrations/2.svg" alt="phones" class="sb-pik-3">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-6 align-self-center">
                                <div class="sb-illustration-2 sb-mb-90">
                                    <div class="sb-interior-frame">
                                        <img src="/src/assets/img/illustrations/interior.jpg" alt="interior" class="sb-interior">
                                    </div>
                        ...
                        <div class="row">
                                ...
                                <a href="#" class="sb-categorie-card sb-categorie-card-2 sb-mb-30">
                                    <div class="sb-card-body">
                                        <div class="sb-category-icon">
                                            <img src="/src/assets/img/categories/1.png" alt="icon">
                                        </div>
                            ...
                            <div class="col-lg-6">
                                <a href="#" class="sb-categorie-card sb-categorie-card-2 sb-mb-30">
                                    <div class="sb-card-body">
                                        <div class="sb-category-icon">
                                            <img src="/src/assets/img/categories/2.png" alt="icon">
                                        </div>
                                        <div class="sb-card-descr">
                            ...
                            <div class="col-lg-6">
                                <a href="#" class="sb-categorie-card sb-categorie-card-2 sb-mb-30">
                                    <div class="sb-card-body">
                                        <div class="sb-category-icon">
                                            <img src="/src/assets/img/categories/3.png" alt="icon">
                                        </div>
                                        <div class="sb-card-descr">
                            ...
                            <div class="col-lg-6">
                                <a href="#" class="sb-categorie-card sb-categorie-card-2 sb-mb-30">
                                    <div class="sb-card-body">
                                        <div class="sb-category-icon">
                                            <img src="/src/assets/img/categories/4.png" alt="icon">
                                        </div>
                                        <div class="sb-card-descr">
                        ...
                        <div class="swiper-container sb-short-menu-slider-4i swiper-container-horizontal">
                            <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
                                <div class="swiper-slide swiper-slide-active" style="width: 270px; margin-right: 30px;">
                                    <a data-fancybox="menu" data-no-swup="" href="/src/assets/img/menu/3.jpg" class="sb-menu-item">
                                        <div class="sb-cover-frame">
                                            <img src="/src/assets/img/menu/3.jpg" alt="product">
                                        </div>
                                ...
                                <div class="swiper-slide swiper-slide-next" style="width: 270px; margin-right: 30px;">
                                    <a data-fancybox="menu" data-no-swup="" href="/src/assets/img/menu/1.jpg" class="sb-menu-item">
                                        <div class="sb-cover-frame">
                                            <img src="/src/assets/img/menu/1.jpg" alt="product">
                                        </div>
                                        <div class="sb-card-tp">
                                ...
                                <div class="swiper-slide" style="width: 270px; margin-right: 30px;">
                                    <a data-fancybox="menu" data-no-swup="" href="/src/assets/img/menu/2.jpg" class="sb-menu-item">
                                        <div class="sb-cover-frame">
                                            <img src="/src/assets/img/menu/2.jpg" alt="product">
                                ...
                                <div class="swiper-slide" style="width: 270px; margin-right: 30px;">
                                    <a data-fancybox="menu" data-no-swup="" href="/src/assets/img/menu/9.jpg" class="sb-menu-item">
                                        <div class="sb-cover-frame">
                                            <img src="/src/assets/img/menu/9.jpg" alt="product">
                                ...
                                <div class="swiper-slide" style="width: 270px; margin-right: 30px;">
                                    <a data-fancybox="menu" data-no-swup="" href="/src/assets/img/menu/5.jpg" class="sb-menu-item">
                                        <div class="sb-cover-frame">
                                            <img src="/src/assets/img/menu/5.jpg" alt="product">
                                            <div class="sb-badge sb-vegan"><i class="fas fa-leaf"></i> Vegan</div>
                                        </div>
                                        <div class="sb-card-tp">
                                            <h4 class="sb-card-title">Carpaccio de daurade</h4>
                                ...
                                <div class="swiper-slide" style="width: 270px; margin-right: 30px;">
                                    <a data-fancybox="menu" data-no-swup="" href="/src/assets/img/menu/4.jpg" class="sb-menu-item">
                                        <div class="sb-cover-frame">
                                            <img src="/src/assets/img/menu/4.jpg" alt="product">
                                        </div>
                                        <div class="sb-card-tp">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="sb-team-member sb-mb-30">
                                    <div class="sb-photo-frame sb-mb-15">
                                        <img src="/src/assets/img/team/1.png" alt="Team member">
                                    </div>
                            ...
                            <div class="col-lg-3">
                                <div class="sb-team-member sb-mb-30">
                                    <div class="sb-photo-frame sb-mb-15">
                                        <img src="/src/assets/img/team/2.png" alt="Team member">
                                    </div>
                                    <div class="sb-member-description">
                            ...
                            <div class="col-lg-3">
                                <div class="sb-team-member sb-mb-30">
                                    <div class="sb-photo-frame sb-mb-15">
                                        <img src="/src/assets/img/team/3.png" alt="Team member">
                                    </div>
                                    <div class="sb-member-description">
                            ...
                            <div class="col-lg-3">
                                <div class="sb-team-member sb-mb-30">
                                    <div class="sb-photo-frame sb-mb-15">
                                        <img src="/src/assets/img/team/4.png" alt="Team member">
                                    </div>
                                    <div class="sb-member-description">
                        ...
                        <div class="row">
                            <div class="col-lg-6 align-self-center">
                                <div class="sb-cta-text">
                                    ...
                                    <a href="#." target="_blank" data-no-swup class="sb-download-btn"><img src="/src/assets/img/buttons/1.svg" alt="img"></a>
                                    <a href="#." target="_blank" data-no-swup class="sb-download-btn"><img src="/src/assets/img/buttons/2.svg" alt="img"></a>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="sb-illustration-3">
                                    <img src="/src/assets/img/illustrations/phones.png" alt="phones" class="sb-phones">
                                    <div class="sb-cirkle-1"></div>
                                    <div class="sb-cirkle-2"></div>
                                    <div class="sb-cirkle-3"></div>
                                    <div class="sb-cirkle-4"></div>
                                    <img src="/src/assets/img/illustrations/1.svg" alt="phones" class="sb-pik-1">
                                    <img src="/src/assets/img/illustrations/2.svg" alt="phones" class="sb-pik-2">
                                    <img src="/src/assets/img/illustrations/3.svg" alt="phones" class="sb-pik-3">
                                </div>
                            </div>
                        </div>
                    </div>
