      ...
      <div class="container">
        <div class="sb-top-bar">
          <a href="#" class="sb-logo-frame">
            <!-- logo img -->
            <img src="/src/assets/bake'ntake.png" class="header-logo" alt="Starbelly">
          </a>
          <!-- menu -->
          <div class="sb-right-side">
            ...
            <div class="sb-buttons-frame">
              ...
              <div class="sb-btn sb-btn-2 sb-btn-gray sb-btn-icon sb-m-0 sb-btn-cart">
                <span class="sb-icon">
                  <img src="/src/assets/img/ui/icons/cart.svg" alt="icon">
                </span>
      ...
      <div class="sb-info-bar">
        <div class="sb-infobar-content">
          ...
          <ul class="sb-instagram sb-mb-30">
            <li><a href="#."><img src="/src/assets/img/instagram/1.jpg" alt="instagram"></a></li>
            <li><a href="#."><img src="/src/assets/img/instagram/2.jpg" alt="instagram"></a></li>
            <li><a href="#."><img src="/src/assets/img/instagram/3.jpg" alt="instagram"></a></li>
            <li><a href="#."><img src="/src/assets/img/instagram/4.jpg" alt="instagram"></a></li>
            <li><a href="#."><img src="/src/assets/img/instagram/5.jpg" alt="instagram"></a></li>
            <li><a href="#."><img src="/src/assets/img/instagram/6.jpg" alt="instagram"></a></li>
          </ul>
          <hr>
          <div class="sb-ib-title-frame sb-mb-30">
          ...
          <a href="#" class="sb-blog-card sb-blog-card-sm sb-mb-30">
            <div class="sb-cover-frame">
              <img src="/src/assets/img/blog/1.jpg" alt="cover">
            </div>
          ...
          <a href="#" class="sb-blog-card sb-blog-card-sm sb-mb-30">
            <div class="sb-cover-frame">
              <img src="/src/assets/img/blog/2.jpg" alt="cover">
            </div>
            <div class="sb-blog-card-descr">
          ...
          <a href="#" class="sb-blog-card sb-blog-card-sm sb-mb-30">
            <div class="sb-cover-frame">
              <img src="/src/assets/img/blog/3.jpg" alt="cover">
            </div>
            <div class="sb-blog-card-descr">
